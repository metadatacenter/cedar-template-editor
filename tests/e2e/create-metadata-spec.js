...
describe('create-metadata', function () {
    ...
    it("should create and remove a text field", function () {
        page.addTextField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-text")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-text")).isPresent()).toBe(false);
    });

    it("should create and remove a text area", function () {
        page.addTextArea();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-paragraph")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-paragraph")).isPresent()).toBe(false);
    });

    it("should create a radio", function () {
        page.addRadio();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-radio")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-radio")).isPresent()).toBe(false);
    });

    it("should create a checkbox", function () {
        page.addCheckbox();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-checkbox")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-checkbox")).isPresent()).toBe(false);
    });
    ...
    it("should create a date", function () {
        ...
        expect(element(by.css("#dialog-add-more")).isPresent()).toBe(true);
        page.addDateField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-calendar")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-calendar")).isPresent()).toBe(false);
    });
    ...
    it("should create an email", function () {
        ...
        expect(element(by.css("#dialog-add-more")).isPresent()).toBe(true);
        page.addEmailField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-at")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-at")).isPresent()).toBe(false);
    });
    ...
    it("should create a list", function () {
        ...
        expect(element(by.css("#dialog-add-more")).isPresent()).toBe(true);
        page.addListField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-list")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-list")).isPresent()).toBe(false);
    });
    ...
    it("should create a numeric", function () {
        ...
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-numeric")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-numeric")).isPresent()).toBe(false);
    });
    ...
    it("should create a phone number", function () {
        ...
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-phone")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-phone")).isPresent()).toBe(false);
    });
    ...
    it("should create a section break", function () {
        ...
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-section-break")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-section-break")).isPresent()).toBe(false);
    });
    ...
    it("should create a rich text field", function () {
        ...
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-rich-text")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-rich-text")).isPresent()).toBe(false);
    });
    ...
    it("should create an image field", function () {
        ...
        expect(element(by.css("#dialog-add-more")).isPresent()).toBe(true);
        page.addImageField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-image")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-image")).isPresent()).toBe(false);
    });
    ...
    it("should create a video field", function () {
        ...
        expect(element(by.css("#dialog-add-more")).isPresent()).toBe(true);
        page.addVideoField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-youtube")).isPresent()).toBe(true);
        page.removeField();
        expect(element(by.css(".field-root .elementTotalContent .cedar-svg-youtube")).isPresent()).toBe(false);
    });
