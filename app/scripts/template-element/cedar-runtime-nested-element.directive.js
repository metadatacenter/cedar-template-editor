  ...
  function cedarRuntimeNestedElementDirective($rootScope, $compile, DataUtilService, DataManipulationService) {
    ...
    function linker(scope, element, attrs) {
      ...
      var nestElement = function () {
        ...
        var template = '<div ng-if="$root.schemaOf(field)._ui.inputType" > <cedar-runtime-field labels="labels" descriptions="descriptions" parent-instance="parentInstance" parent-model="parentModel" previous="previous" field="field" model="model" delete="removeChild(field)" preview="false" rename-child-key="renameChildKey" is-edit-data="isEditData" uid="uid" path="path" parent-key="parentKey" field-key="fieldKey"></cedar-runtime-field></div><div ng-if="!$root.schemaOf(field)._ui.inputType" class="nested-element"><cedar-runtime-element labels="labels" descriptions="descriptions" relabel="relable"  model="model" element="field" preview="preview" delete="removeChild(field)"  uid="uid"  path="path" parent-key="parentKey" field-key="fieldKey"></cedar-runtime-element></div>';
