    ...
    function linker(scope, element, attrs) {
      ...
      scope.nestElement = function () {
        ...
        var getNested = function () {
          // Nesting is a structural UI fact, not an artifact-identifier fact.
          // New children correctly have no @id, so comparing their identifiers
          // made every level look like the root until the repository stored it.
          return scope.$parent.isRoot ? !scope.$parent.isRoot() : false;
        };
