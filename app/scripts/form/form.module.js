...
define([
  ...
  'cedar/template-editor/form/numeric-validation.directive',
  'cedar/template-editor/form/string-validation.directive',
  ...
  angular.module('cedar.templateEditor.form', [
    ...
    'cedar.templateEditor.form.numericValidationDirective',
    'cedar.templateEditor.form.stringValidationDirective',
