...
define([
  ...
  angular.module('cedar.templateEditor.form.angularValidatorDirective', [])
    .directive('angularValidator', angularValidatorDirective);
 
  // TODO: refactor to cedarAngularValidator <cedar-angular-validator>

  angularValidatorDirective.$inject = [];

  /**
   * Angular Validator Directive
   * heavily influenced by https://github.com/turinggroup/angular-validator
   * with some necessary adaption for forms dynamically loaded
   */
  function angularValidatorDirective() {
    ...
    return {
      ...
      link: function(scope, element, attrs, fn) {
        ...
        element.on('submit', function(event) {
          ...
          if (scopeForm.$valid) {
            scope.$apply(function() {
              if (DOMForm.attributes['angular-validateor-submit']) {
