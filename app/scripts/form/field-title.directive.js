...
define([
  ...
  angular.module('cedar.templateEditor.form.fieldTitle', [])
      .directive('fieldTitle', fieldTitle);


  fieldTitle.$inject = ['UIUtilService','DataManipulationService', 'DataUtilService'];

  function fieldTitle(UIUtilService, DataManipulationService, DataUtilService) {
