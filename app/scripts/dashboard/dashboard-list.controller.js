...
define([
  ...
  angular.module('cedar.templateEditor.dashboard.dashboardListController', [])
  ...
  DashboardListController.$inject = ["$rootScope", "$scope", "$routeParams", "$location", "$translate", "HeaderService",
                                     "UrlService", "TemplateService", "TemplateElementService",
                                     "TemplateInstanceService", "UIMessageService", "AuthorizedBackendService",
                                     "CONST"];

  function DashboardListController($rootScope, $scope, $routeParams, $location, $translate, HeaderService, UrlService,
                                   TemplateService, TemplateElementService, TemplateInstanceService, UIMessageService,
