...
define([
  ...
  angular.module('cedar.templateEditor.layout.positionJsonToolsDirective', [])
    .directive('cedarPositionJsonTools', cedarPositionJsonTools);

  cedarPositionJsonTools.$inject = ['$window', '$document', '$timeout'];

  function cedarPositionJsonTools($window, $document, $timeout) {
